    ...
    <nav class="navbar">
      <ul class="navlist">
        ...
        if (isset($_SESSION['username'])) { ?>
          ...
          <li class="navitem navlink active"><a href="/php-twitter/followings">دنبال‌شدگان</a></li>
        <?php } else { ?>
          <li class="navitem navlink active"><a href="/php-twitter/login">دنبال‌شدگان</a></li>
        <?php
        }
        ?>
        <?php
