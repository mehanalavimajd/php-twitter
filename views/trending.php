...
<header>
    ...
    <nav class="navbar">
      <ul class="navlist">
        ...
        <li class="navitem navlink"><a href="/php-twitter">صفحه اصلی</a></li>
        <?php
        session_start();
        ...
        <?php
        if (isset($_SESSION['username'])) { ?>
          <li class="navitem navlink  active "><a href="/php-twitter/trending">محبوب‌ترین ها</a></li>
        <?php } else { ?>
          <li class="navitem navlink  active "><a href="/php-twitter/login">محبوب‌ترین ها</a></li>
        <?php
        }
        ?>
